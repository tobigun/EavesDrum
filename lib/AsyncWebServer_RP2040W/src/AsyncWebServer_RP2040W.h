...
#define ASYNC_WEBSERVER_RP2040W_VERSION           "AsyncWebServer_RP2040W v1.5.0"

#define ASYNC_WEBSERVER_RP2040W_VERSION_MAJOR     1
#define ASYNC_WEBSERVER_RP2040W_VERSION_MINOR     5
#define ASYNC_WEBSERVER_RP2040W_VERSION_PATCH     0

#define ASYNC_WEBSERVER_RP2040W_VERSION_INT       1005000

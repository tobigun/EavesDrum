...
#define _TOA(value, str, base, prefix, decType) \
  switch (base) {                               \
  case 8:                                       \
    sprintf(str, prefix "o", value);            \
    break;                                      \
  case 10:                                      \
    sprintf(str, prefix decType, value);        \
    break;                                      \
  case 16:                                      \
    sprintf(str, prefix "x", value);            \
    break;                                      \
  }

#define itoa(value, str, base) _TOA(value, str, base, "%", "d")
#define ltoa(value, str, base) _TOA(value, str, base, "%l", "d")
#define utoa(value, str, base) _TOA(value, str, base, "%", "u")
#define ultoa(value, str, base) _TOA(value, str, base, "%l", "u")
#define ulltoa(value, str, base) _TOA(value, str, base, "%ll", "u")
#else
#define utoa ltoa
#define ultoa ltoa
#endif
